...
public class OkHttp3Utils {
    ...
    //设置缓存目录
    private static File cacheDirectory = new File(MyApplication.getInstance().context.getCacheDir().getAbsolutePath(), "MyCache");
    ...
    public static OkHttpClient getOkHttpClient() {
        if (null == mOkHttpClient) {
            ...
            httpLoggingInterceptor.setLevel(HttpLoggingInterceptor.Level.BODY);   //日志打印
